...
import { supabase } from '@/utils/supabase'; // Asegúrate de tener este archivo creado
...
const Solicitud = () => {
    ...
    // Estado para el feedback del usuario (Cargando, Éxito, Error)
    ...
    const handleSubmit = async (e) => {
        ...
        const { error } = await supabase
            .from('CLIENTES_DEMO') // Tu tabla de Supabase
            .insert([
                { 
                    nombre: formData.name,      // Mapeo: ID del form -> Columna DB
        ...
        if (error) {
            ...
            setFormData({ name: '', email: '', company: '', phone: '', role: '', interest: '' }); // Limpia el form
        }
    };
                    ...
                    <div className="relative group perspective-1000">
                        ...
                        <div className="relative bg-[#132328]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-10 shadow-2xl">
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                ...
                                {/* Selects para Cargo e Interés */}
                                <div className="space-y-1 form-field">
                                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1" htmlFor="service">
                                        Servicio de Interés
                                    </label>
                                    <div className="relative">
                                        <select
                                            ...
                                            id="service" // Debe coincidir con el nombre en el estado
                                        ...
                                        <span className="absolute right-4 top-3.5 text-gray-500 material-symbols-outlined pointer-events-none text-[20px]">
                                            expand_more
                                        </span>
                                    </div>
                                </div>
