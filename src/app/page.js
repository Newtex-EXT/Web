  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      function createGlobe() {
        ...
        const positions = []; const radius = 2.0; const NUM_POINTS = 10000;
      ...
      function addStars() {
        ...
        createStarSphere(60, 2000);
        createStarSphere(90, 2000);
      ...
      tl.to(nebulaMaterial.uniforms.uOpacity, { value: 0.2, duration: 1.5 })
        ...
        .to(".tech-card", { opacity: 0, stagger: -0.1, duration: 1.5 }, "<")
      ...
      <main className="flex min-h-screen flex-col text-white">
        ...
        <section id="inicio" className="hero-section min-h-screen flex items-center justify-center">
            <div className="text-center">
                <h1 className="text-6xl font-extrabold hero-title" style={{ fontFamily: "'Trebuchet MS', sans-serif" }}>NEXA</h1>
