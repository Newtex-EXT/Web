          ...
          <div className="contact-form bg-white/5 p-8 rounded-xl backdrop-blur-md border border-white/10 shadow-2xl">
            ...
            <form className="space-y-5">
              <div>
                ...
                <input type="text" id="name" className="w-full bg-[#101022]/80 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#00CFFF] focus:ring-1 focus:ring-[#00CFFF] transition-all placeholder-gray-600 text-sm" placeholder="Tu nombre completo" />
              </div>
              <div>
                <label htmlFor="email" className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Email</label>
                <input type="email" id="email" className="w-full bg-[#101022]/80 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#00CFFF] focus:ring-1 focus:ring-[#00CFFF] transition-all placeholder-gray-600 text-sm" placeholder="tu@empresa.com" />
              </div>
              <div>
                <label htmlFor="message" className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Mensaje</label>
                <textarea id="message" rows="4" className="w-full bg-[#101022]/80 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#00CFFF] focus:ring-1 focus:ring-[#00CFFF] transition-all placeholder-gray-600 text-sm resize-none" placeholder="Cuéntanos brevemente sobre tu proyecto..."></textarea>
              </div>
              <button type="submit" className="w-full bg-[#00CFFF] hover:bg-[#33d9ff] text-black font-bold py-3.5 rounded-lg transition-all shadow-[0_0_20px_rgba(0,207,255,0.2)] hover:shadow-[0_0_30px_rgba(0,207,255,0.4)] uppercase text-xs tracking-widest mt-2">
                Enviar Mensaje
              </button>
            </form>
          </div>
